...
export function NewsFeed() {
  ...
  return (
    <section className="animate-fade-in" style={{ animationDelay: "150ms" }}>
      ...
      {/* Glass Container */}
      <div className="relative p-4 rounded-2xl bg-card border border-border shadow-[0_2px_15px_-3px_rgba(0,0,0,0.1),0_4px_6px_-4px_rgba(0,0,0,0.1)]">
        ...
        <div className="overflow-hidden" ref={emblaRef}>
          <div className="flex gap-3 sm:gap-4">
            {(filteredNews.length > 0 ? filteredNews : mockNews).map((news) => (
              ...
              >
                {/* News Card */}
                <div className="relative rounded-2xl bg-card border border-border shadow-[0_2px_15px_-3px_rgba(0,0,0,0.1),0_4px_6px_-4px_rgba(0,0,0,0.1)] overflow-hidden group h-full flex flex-col">
                  {/* Image */}
