            ...
            {filteredPosts.map((post) => (
              ...
              >
                ...
                <div 
                  ...
                  className={`relative rounded-2xl bg-muted border shadow-md overflow-hidden group hover:bg-card hover:shadow-lg transition-all duration-300 h-full flex flex-col cursor-pointer ${
                    post.type === "kudos" 
