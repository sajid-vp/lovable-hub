        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {items.map((item, index) => {
            ...
            return (
              ...
              >
                <div className="p-2 rounded-lg flex-shrink-0 flex items-center justify-center transition-all duration-300 bg-[hsl(var(--light-blue))] group-hover:bg-white group-hover:shadow-sm">
                  <item.icon className="h-4 w-4 text-white transition-all duration-300 group-hover:text-[hsl(var(--light-blue))] group-hover:fill-white" strokeWidth={1.5} />
                </div>
